...
-- Dentro de cada elección separa los votos por: circuito, tipo de voto y partido político
...
CREATE OR REPLACE VIEW resultados_eleccion_circuito AS
    ...
    GROUP BY eleccion, circuito, partido_politico, tipo_voto
    ORDER BY eleccion, circuito, partido_politico, tipo_voto;
